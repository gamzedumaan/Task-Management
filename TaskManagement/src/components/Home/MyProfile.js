    ...
    <ScrollView style={styles.container}>
      <View style={styles.containerBorder}>
        ...
        <TouchableOpacity style={styles.Touchable}>
          ...
          <Icon style={styles.Icon7} name="right" size={15} color="white" />
        </TouchableOpacity>
        <TouchableOpacity style={styles.Touchable}>
          <View style={styles.containerStopwatch}>
            <Icon name="stopwatch" size={16} color="white" />
          </View>

          <Text style={styles.setText}>Set Local time zone</Text>
          <Icon style={styles.Icon7} name="right" size={16} color="white" />
        </TouchableOpacity>
        <TouchableOpacity style={styles.Touchable}>
        ...
        <TouchableOpacity style={styles.Touchable}>
          <View style={styles.containerHelp}>
            <Icon style={styles.Icon6} name="help" size={15} color="white" />
          </View>
